...
def heuristic(state, piece):
    ...
    if kind == 1:
        ...
        if h[0]<h[1] and h[0]>=4:
            if piece[1][1]!=0:
                return (0,0)
            else:
                return (0,1)
        elif h[0]==h[1] and h[0]>=5:
            if piece[1][1]!=0:
                return (0,0)
            else:
                return (0,1)
        elif h[0]>h[1] and h[1]>=4:
            if piece[1][1]!=0:
                return (0,1)
            else:
                return (0,0)
        elif h[3]<h[4] and h[3]>=3:
            if piece[1][1]!=0:
                return (3,0)
            else:
                return (3,1)
        elif h[3]==h[4] and h[3]>=4:
            if piece[1][1]!=0:
                return (3,0)
            else:
                return (3,1)
        elif h[3]>h[4] and h[4]>=3:
            if piece[1][1]!=0:
                return (3,1)
            else:
                return (3,0)
...
class TetrisAI:
    ...
    def choose_action(self, state, possible_actions):
        ...
        ######Heuristic######
        best_action = heuristic(self.game.board,self.game.piece)
        if best_action != None:
